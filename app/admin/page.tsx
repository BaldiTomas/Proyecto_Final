          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-400 mt-1">
                Gestiona usuarios, productos y configuración del sistema
              </p>
            </div>
            <Badge
              variant="secondary"
              className="w-fit bg-slate-700 text-gray-300"
            >
                    ...
                    {[
                      {
                        ...
                        details: "Nueva cuenta de productor creada",
                        time: "hace 5 min",
                      },
                      {
                        action: "Producto verificado",
                        details: "Penicilina G aprobado",
                        time: "hace 12 min",
                      },
                      {
                        action: "Venta completada",
                        details: "Transacción #834 procesada",
                        time: "hace 1 hora",
                      },
                      {
                        action: "Nuevo reporte generado",
                        details: "Reporte de La Noche Estrellada — Vincent van Gogh generado",
                        time: "hace 2 horas",
                      },
                    ].map((activity, index) => (
                      <div
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-slate-800 border-slate-700">
                  <CardHeader>
                    ...
                    <CardDescription className="text-gray-400">
                      Configurar ajustes de red blockchain
                    </CardDescription>
                  </CardHeader>
                  <CardContent>
                    <div className="space-y-4">
                  ...
                  <CardContent>
                    <div className="space-y-4">
                      <div>
                        ...
                        <p className="text-sm text-gray-400">Contraseña establecida</p>
                      </div>
                      <div>
                        <label className="text-sm font-medium text-white">
                          Tiempo de Sesión
                        </label>
                        <p className="text-sm text-gray-400">10 minutos</p>
                      </div>
                      <Button
                        variant="outline"
                        className="border-slate-600 text-gray-300 bg-transparent"
