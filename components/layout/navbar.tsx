...
export function Navbar() {
  ...
  const getNavigationItems = () => {
    ...
    switch (user.role) {
      case "admin":
        return [...baseItems, { href: "/admin", label: "Admin Panel", icon: Shield }]
      case "distributor":
        return [...baseItems, { href: "/distributor", label: "Distribución", icon: Truck }]
      default:
        return baseItems
    }
  }
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="ghost" className="flex items-center space-x-2 text-gray-300 hover:text-white">
                  ...
                  <Badge variant="secondary" className="hidden sm:block bg-slate-700 text-gray-300">
              ...
              <DropdownMenuContent align="end" className="bg-slate-800 border-slate-700">
                ...
                <DropdownMenuItem onClick={handleLogout} className="text-gray-300 hover:text-white hover:bg-slate-700">
